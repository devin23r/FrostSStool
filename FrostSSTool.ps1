...
@($quickButton, $fullButton, $modsButton, $foldersButton, $logsButton, $processButton, $recentButton, $prefetchButton, $fileButton, $exportButton, $clearButton) | ForEach-Object { [void]$nav.Controls.Add($_) }
